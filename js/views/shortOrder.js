define(["jquery","underscore","hbs!templates/shortOrder","marionette_node"],function($,_,templateFile, Marionette) {
    var ShortOrderView = Marionette.ItemView.extend({
